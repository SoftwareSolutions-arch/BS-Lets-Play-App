...
@Component({
  selector: "app-change-paassword",
  templateUrl: "./change-paassword.page.html",
  styleUrls: ["./change-paassword.page.scss"]
})
export class ChangePaasswordPage implements OnInit {
